...
<body >
	...
	PreparedStatement pstmt=con.prepareStatement("select * from complaints where cdepartment=? and cid=?");
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="grid_3 grid_5 widget-shadow">
					<h3 class="hdg">Comments</h3>
					<div class="alert alert-success" role="alert">
						<strong>Title : <%= rs.getString("ctitle") %></strong>   <%=rs.getString("comment") %>
					</div>
